					...
					<div className="flex flex-row lg:flex-col gap-4 lg:gap-0 items-center">
						<div className="text-4xl lg:text-5xl flex items-center justify-center">
							{visible ? (
								...
								<HangarIcon fill="white" stroke="current" alt="" className="w-14 h-14" />
							)}
						</div>

						{!visible ? <div className="tracking-widest font-medium">HANGARS</div> : null}
					</div>
				</div>
				<div className="flex flex-col gap-10 items-center justify-center px-5 py-4 bg-base-600 w-[30rem] shadow-xl">
					<div className="text-2xl 2k:text-3xl text-slate-100 font-semibold w-full bg-primary text-center py-4 px-6 rounded-t-lg border-b-4 border-primary-focus border-solid">Drag & Drop a Build on Hangar to Save</div>
