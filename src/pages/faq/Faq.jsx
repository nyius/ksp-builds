		...
		<MiddleContainer>
			...
			<div tabIndex={0} className="collapse border border-base-300 bg-base-100 rounded-box">
				...
				<div className="collapse-content text-3xl">
					...
					<ul className="steps steps-vertical !auto-rows-min">
						<li className="step !text-start p-3">First you'll want to click the 'upload' button on the navbar</li>
						<li className="step !text-start p-3">
			...
			<div tabIndex={1} className="collapse border border-base-300 bg-base-100 rounded-box">
				...
				<div className="collapse-content text-3xl">
					...
					<ul className="steps steps-vertical !auto-rows-min">
						<li className="step !text-start p-3">First you'll want to find a build you want to try out</li>
						<li className="step !text-start p-3">Then, click the "Export to KSP2" Button and it will copy the whole craft JSON text to your clipboard</li>
						<li className="step !text-start p-3">
