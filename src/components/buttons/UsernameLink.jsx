...
function UsernameLink({ username, uid, hoverPosition, noHoverUi, color }) {
	...
	const { fetchConversation, setHoverUser } = useAuth();
			...
			<div className="dropdown z-100" onMouseEnter={handleHover} onMouseLeave={e => handleBlur(e)} onClick={e => e.stopPropagation()}>
				...
				{!noHoverUi && hover && (
					<div
						...
						} cursor-auto bg-base-900 p-2 shadow ${color ? color : 'bg-base-100'}  rounded-box w-111 2k:w-115`}
					>
						<div className="flex flex-col p-3 w-full">
							...
							<div className="flex flex-row gap-2 2k:gap-4 w-full">
