...
function ChallengeCard({ challenge, i }) {
	return (
		<Link to={`/challenges/${challenge.articleId}`} className="flex w-full p-1 hover:bg-primary rounded-xl cursor-pointer">
			<div className="flex flex-col lg:flex-row bg-base-900 w-full rounded-xl gap-4 lg:h-102">
				...
				<div className="flex flex-col px-6 py-16 flex-1 relative w-full">
					...
					<div className="max-h-80 overflow-hidden challenge-fade">
